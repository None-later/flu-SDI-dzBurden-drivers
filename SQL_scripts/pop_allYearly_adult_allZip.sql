...
- population size
- year
- adults only: 15-19, 20-29, 30-39, 40-49, 50-59, 60-69
- include zip3s
...
SELECT year(flu.WEEK), flu.patient_zip3, flu.popstat FROM flu
	WHERE flu.SERVICE_PLACE = "TOTAL" and (flu.AGEGROUP = "15-19 years" or flu.AGEGROUP = "20-29 years" or flu.AGEGROUP = "30-39 years" or flu.AGEGROUP = "40-49 years" or flu.AGEGROUP = "50-59 years" or flu.AGEGROUP = "60-69 years") AND flu.patient_zip3 <> "TOT"
