...
# write.csv(allMods_fit_ILI, file='periodicReg_t2_allZip3Mods_ILI.csv', row.names=FALSE)
# # write tidy coefficient dataset
# write.csv(allMods_tidy, file='tidyCoef_periodicReg_t2_allZip3Mods_ILI.csv', row.names=FALSE)
# # write summary statistics for all models
# write.csv(allMods_glance, file='summaryStats_periodicReg_t2_allZip3Mods_ILI.csv', row.names=FALSE)