...
write_fullIndic_periodicReg_ilicnDt <- function(span.var, degree.var){
...
#   degree.var <- 2
  ...
  write.csv(data5, file = sprintf('fullIndicFlu_periodicReg_%silicnDt%s%s_analyzeDB.csv', code, code2, code.str), row.names=FALSE)
  write.csv(data6, file = sprintf('fullIndicAll_periodicReg_%silicnDt%s%s_analyzeDB.csv', code, code2, code.str), row.names=FALSE)
