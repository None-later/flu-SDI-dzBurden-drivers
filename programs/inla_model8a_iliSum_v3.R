...
## Name: Elizabeth Lee
## Date: 12/16/16
## Function: Model 8a v3: CAR spatial model, shifted response variable (e.g., seasonal intensity 0 -> 1), with interaction terms, child population only
...
modCodeStr <- "8a_iliSum_v3-2"; testDataOn <- FALSE
rdmFx_RV <- "phi"
likString <- "normal"
