...
## Name: Elizabeth Lee
## Date: 10/4/16
## Function: Model 6a V6, non-zero component of hurdle model, with CAR term
...
modCodeStr <- "6a_iliSum_v6-1"; testDataOn <- FALSE
seasons <- 2:9
rdmFx_RV <- "nu"
...
#   plot_fixedFx_marginals(path_plotExport_fixedFxMarginals, mod$marginals.fixed, modCodeStr, s)
  ...
  # plot_countyChoro(path_plotExport_obsY, modData_full, "y1", "tier", TRUE)
