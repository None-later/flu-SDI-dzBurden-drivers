...
## Name: Elizabeth Lee
## Date: 12/17/16
## Function: Model 9a v1, one-season model, shift1 iliSum, total population, no spatial dependence term
## 
...
modCodeStr <- "9a_iliSum_v1-1"; testDataOn <- FALSE
seasons <- 3:9
rdmFx_RV <- "nu"
likString <- "normal"
...
#### Import and process data ####
  modData <- model7a_iliSum_v6(path_list) 
    #%>%
