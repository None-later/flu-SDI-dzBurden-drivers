...
## Name: Elizabeth Lee
## Date: 1/10/17
## Function: Model 8e v4: county neighbor spatial model, epidemic duration response variable, with interaction terms, adult population only
...
modCodeStr <- "8e_epiDur_v4-2"; testDataOn <- FALSE
rdmFx_RV <- "phi"
likString <- "poisson"
...
#### Import and process data ####
  modData <- model8e_epiDur_v4(path_list) # with driver & sampling effort variables
    #%>%
