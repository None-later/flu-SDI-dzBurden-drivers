...
# Covariates, sampling effort & unstructured spatial random effect
formula <- logy ~ -1 + f(ID, model = "iid") + I(O_imscoverage) + I(O_careseek) + I(O_insured) + I(X_poverty)
