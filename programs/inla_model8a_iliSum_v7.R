...
## Name: Elizabeth Lee
## Date: 12/21/16
## Function: Model 8a v7: neighbor county CAR spatial model, flight passenger state CAR spatial model, shifted response variable (e.g., seasonal intensity 0 -> 1), with interaction terms
...
modCodeStr <- "8a_iliSum_v7-1"; testDataOn <- FALSE
rdmFx_RV <- "phi"
likString <- "normal"
