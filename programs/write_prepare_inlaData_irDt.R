...
path_response_cty <- paste0(getwd(), sprintf("/dbMetrics_periodicReg%s_analyzeDB_cty_dzBurdenMS.csv", dbCodeStr))
path_fullIndic_cty <- paste0(getwd(), sprintf("/fullIndicAll_periodicReg%s_analyzeDB_cty_dzBurdenMS.csv", dbCodeStr))
...
#### MAIN #################################
#### county level data ####
mod_8aV7 <- model8a_iliSum_irDt_v7(path_list)
mod_8eV7 <- model8e_epiDur_irDt_v7(path_list)

write_csv(mod_8aV7, paste0(path_dataExport, "inlaImport_model8a_iliSum_irDt_v7.csv"))
write_csv(mod_8eV7, paste0(path_dataExport, "inlaImport_model8e_epiDur_irDt_v7.csv"))
