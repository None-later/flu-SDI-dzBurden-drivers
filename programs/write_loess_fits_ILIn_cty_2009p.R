...
## Name: Elizabeth Lee
## Date: 4/17/17
## Function: Rerun data processing to accomodate 2009 pandemic timeframe. downscale ILIn from zip3 to county, smooth ILIn data using loess smoother during summer weeks, divide observed ili by smoothed loess fits for entire time series. Pass the processed ILI metric to write_loess_PeriodicReg_....R
