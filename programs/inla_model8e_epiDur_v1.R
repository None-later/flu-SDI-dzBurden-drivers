...
## Name: Elizabeth Lee
## Date: 12/16/16
## Function: Model 8e v1: iid spatial model, epidemic duration response variable, with interaction terms and no spatial dependence
...
modCodeStr <- "8e_epiDur_v1-1"; testDataOn <- FALSE
rdmFx_RV <- "nu"
likString <- "poisson"
...
#### Import and process data ####
  modData <- model8e_epiDur_v7(path_list) # with driver & sampling effort variables
    #%>%
