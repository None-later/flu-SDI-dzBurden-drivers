...
## Name: Elizabeth Lee
## Date: 10/26/16
## Function: Model 7a v4 covariate & sampling effort gamma model, add error term for each observation 
...
modCodeStr <- "7a_iliSum_v4-6"; testDataOn <- FALSE
rdmFx_RV <- "nu"
...
#### Import and process data ####
  ...
  modData <- dummy %>%
    remove_randomObs_stratifySeas(0.2)
...
plot_rdmFx_marginalsSample(path_plotExport_rdmFxSample_nonzero, mod$marginals.random$ID_nonzero, rdmFx_RV)
