...
## Name: Elizabeth Lee
## Date: 10/24/16
## Function: Model 7cd v3 covariate & sampling effort gamma model, ilinDt.excess.thresh model (7d)
...
modCodeStr <- "7d_iliExcessThresh_v3-1"; testDataOn <- FALSE
rdmFx_RV <- "nu"
...
#### Import and process data ####
  dummy <- model6d_iliExcessThresh_v1(path_list) # with driver & sampling effort variables
  modData <- remove_case_exceptions(dummy)
