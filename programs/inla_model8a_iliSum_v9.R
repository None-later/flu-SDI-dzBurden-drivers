...
## Name: Elizabeth Lee
## Date: 12/16/16
## Function: Model 8a v6: CAR spatial model - state flight passengers, shifted response variable (e.g., seasonal intensity 0 -> 1), with interaction terms
...
modCodeStr <- "8a_iliSum_v9-1"; testDataOn <- FALSE
rdmFx_RV <- "phi"
likString <- "normal"
...
#### Import and process data ####
  modData <- model8a_iliSum_v6(path_list) # with driver & sampling effort variables
    #%>%
