...
## Name: Elizabeth Lee
## Date: 12/17/16
## Function: Model 8a v4: CAR spatial model, shifted response variable (e.g., seasonal intensity 0 -> 1), with interaction terms, adults only
...
modCodeStr <- "8a_iliSum_v4-5"; testDataOn <- FALSE
rdmFx_RV <- "phi"
likString <- "normal"
...
#### Import and process data ####
  modData <- model8a_iliSum_v4(path_list) # with driver & sampling effort variables
    #%>%
