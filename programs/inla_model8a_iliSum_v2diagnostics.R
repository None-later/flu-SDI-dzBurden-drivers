...
## Name: Elizabeth Lee
## Date: 5/1/17
## Function: Model 8a v2 diagnostics: CAR spatial model, shifted response variable (e.g., seasonal intensity 0 -> 1), with interaction terms; rm different random effects for testing
...
# single code
modCodeLs <- c("8a_iliSum_v2-6_rmCtyFx")
