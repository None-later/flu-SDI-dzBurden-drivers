...
## Name: Elizabeth Lee
## Date: 6/21/16
## Function: Model 5b, v1-1 covariate & sampling effort model across all seasons-- after variable selection
## v1-1: One model across all seasons, see variables selected in 'Drivers' spreadsheet
...
modCodeStr <- "5b_iliPeak_v1-2"; testDataOn <- FALSE
seasons <- 2:9
rdmFx_RV <- "nu"
...
#### Import and process data ####
  modData <- model5b_iliPeak_v1(path_list) # with driver & sampling effort variables
