...
model8e_epiDur_v3 <- function(filepathList){
  # 1/10/17 model 8e_v3 -- (age-specific careseek) -- child population
  # epiDur count response in weeks, all sampling effort, and driver variables
...
model8e_epiDur_v4 <- function(filepathList){
  # 1/10/17 model 8e_v4 -- (age-specific careseek) -- adult population
  # epiDur count response in weeks, all sampling effort, and driver variables
  # with county spatial term
  # y1 = non-zero response, E = expected response
  print(match.call())
...
model8e_epiDur_v7 <- function(filepathList){
  # 1/6/17 model 8e_v7 -- total population
  # epiDur count response in weeks, all sampling effort, and driver variables
  # with 2 spatial terms - state flight passenger, county neighbor
  # y1 = non-zero response, E = expected response
  print(match.call())
