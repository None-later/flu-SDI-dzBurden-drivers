...
## Name: Elizabeth Lee
## Date: 6/8/16
## Function: Model 5b, v2 covariate & sampling effort model with spatial CAR effects -- after variable selection, iliPeak
## v2-1: One model per season, see variables selected in 'Drivers' spreadsheet
