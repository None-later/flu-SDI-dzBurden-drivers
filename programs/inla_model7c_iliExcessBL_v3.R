...
## Name: Elizabeth Lee
## Date: 10/24/16
## Function: Model 7c v3 covariate & sampling effort gamma model, ilinDt.excess.BL model (7c)
...
modCodeStr <- "7c_iliExcessBL_v3-1"; testDataOn <- FALSE
rdmFx_RV <- "nu"
...
#### Import and process data ####
  dummy <- model6c_iliExcessBL_v1(path_list) # with driver & sampling effort variables
  modData <- remove_case_exceptions(dummy)
