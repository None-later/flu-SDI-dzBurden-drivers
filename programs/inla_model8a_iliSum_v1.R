...
## Name: Elizabeth Lee
## Date: 12/16/16
## Function: Model 8a v1: iid spatial model, shifted response variable (e.g., seasonal intensity 0 -> 1), with interaction terms and no spatial dependence
...
modCodeStr <- "8a_iliSum_v1-1"; testDataOn <- FALSE
rdmFx_RV <- "nu"
likString <- "normal"
...
#### Import and process data ####
  modData <- model7a_iliSum_v6(path_list) # with driver & sampling effort variables
    #%>%
