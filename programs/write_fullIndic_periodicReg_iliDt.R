...
# these data are used in "write_relativeDiseaseBurden_iliDt.R" for further processing of disease burden metrics
write.csv(data5, file = sprintf('fullIndicFlu_periodicReg_%siliDt%s%s_analyzeDB.csv', code, code2, code.str), row.names=FALSE)
write.csv(data6, file = sprintf('fullIndicAll_periodicReg_%siliDt%s%s_analyzeDB.csv', code, code2, code.str), row.names=FALSE)
