...
explore_dbMetricsDistribution_ilicnDt <- function(span.var, degree.var, spatial){
  ...
  #### import data ####################################
  setwd('../R_export')
  dbMetrics.g <- read_csv(sprintf('dbMetrics_periodicReg_%silicnDt%s%s_analyzeDB%s.csv', code, code2, code.str, spatial$stringabbr), col_types="iccd") %>% filter(season!=1)
  # standardized data
  ...
  dir.create(sprintf('../graph_outputs/explore_dbMetricsDistribution_%silicnDt%s%s%s', code, code2, code.str, spatial$stringabbr), showWarnings=FALSE)
  setwd(sprintf('../graph_outputs/explore_dbMetricsDistribution_%silicnDt%s%s%s', code, code2, code.str, spatial$stringabbr))
  ...
  ggsave(sprintf("distr_ILITot_%silicnDt%s%s%s.png", code, code2, code.str, spatial$stringabbr), plt.distr.iliSum, width=w, height=h)
  ...
  ggsave(sprintf("distr_ILIexcessBL_%silicnDt%s%s%s.png", code, code2, code.str, spatial$stringabbr), plt.distr.ILIexcessBL, width=w, height=h)
  ...
  ggsave(sprintf("distr_ILIexcessThresh_%silicnDt%s%s%s.png", code, code2, code.str, spatial$stringabbr), plt.distr.ILIexcessThresh, width=w, height=h)
  ...
  ggsave(sprintf("distr_pkCount_%silicnDt%s%s%s.png", code, code2, code.str, spatial$stringabbr), plt.distr.pkCount, width=w, height=h)
  ...
  ggsave(sprintf("distr_epiDur_%silicnDt%s%s%s.png", code, code2, code.str, spatial$stringabbr), plt.distr.epiDur, width=w, height=h)
  ...
  ggsave(sprintf("distr_epiTime_%silicnDt%s%s%s.png", code, code2, code.str, spatial$stringabbr), plt.distr.epiTime, width=w, height=h)
  ...
  ggsave(sprintf("distr_pkTime_%silicnDt%s%s%s.png", code, code2, code.str, spatial$stringabbr), plt.distr.pkTime, width=w, height=h)
