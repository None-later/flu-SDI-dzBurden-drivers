...
## Name: Elizabeth Lee
## Date: 1/10/17
## Function: Model 8e v3: county neighbor spatial model, epidemic duration response variable, with interaction terms, child population only
...
modCodeStr <- "8e_epiDur_v3-2"; testDataOn <- FALSE
rdmFx_RV <- "phi"
likString <- "poisson"
...
#### Import and process data ####
  modData <- model8e_epiDur_v3(path_list) # with driver & sampling effort variables
    #%>%
