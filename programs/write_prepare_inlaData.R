...
#### MAIN #################################
#### county level data ####
mod_8aV7 <- model8a_iliSum_v7(path_list) 
mod_8eV7 <- model8e_epiDur_v7(path_list)

write_csv(mod_8aV7, paste0(path_dataExport, "inlaImport_model8a_iliSum_v7.csv"))
write_csv(mod_8eV7, paste0(path_dataExport, "inlaImport_model8e_epiDur_v7.csv"))
