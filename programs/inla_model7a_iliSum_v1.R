...
modCodeStr <- "7a_iliSum_v1testing1"; testDataOn <- TRUE
rdmFx_RV <- "nu"
...
modData_hurdle <- convert_hurdleModel_separatePredictors_spatiotemporal(modData_full)
...
path_plotExport_rdmFxSample_bin <- paste0(path_plotExport, sprintf("/inla_%s_%s1-6_marg_binomial.png", modCodeStr, rdmFx_RV))
